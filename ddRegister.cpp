...
//para asociar un puerto (ej: PORTC y PORTD) con un registro DDR (ej: DDRC y DDRD) el cual tendrá el control sobre
//los modos de direccion de los pines del puerto
...
byte_t DDRegister::Read() {		//lee el valor byte de un DDRegister
    return byte;	//byte es el atributo de la clase/struct Byte, de la k deriva ByteRegister, de la k deriva DDRegister
}
