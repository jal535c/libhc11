...
private:        
	...
	bool waiting;	//son puestas a false en el metodo Reset(), llamado desde el constructor
...
protected:	//las clases derivadas pueden acceder
	...
	static bool ServiceTO(HC11 *hc11);		//la implementacion de estas funciones está en interrup.cpp
